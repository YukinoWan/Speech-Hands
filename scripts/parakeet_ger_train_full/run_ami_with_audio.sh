...
#SBATCH --job-name=qwen2_5omni_full_sharegpt_ami-ger-with-audio
#SBATCH --output=parakeet_log/qwen2_5omni_full_sharegpt_ami-ger-with-audio
#SBATCH --error=parakeet_log/qwen2_5omni_full_sharegpt_ami-ger-with-audio
#SBATCH --ntasks=1
...
FORCE_TORCHRUN=1 llamafactory-cli train examples/parakeet_ger_train_full/qwen2_5omni_full_sft_ami_with_audio.yaml
bash ./merge_full_ger.sh "ami" "parakeet_v2_ger"

sbatch ./scripts/parakeet_eval/eval_ger.sh "ami_test" "parakeet_v2_ger"
sbatch ./scripts/parakeet_eval/eval_ger.sh "ami_train" "parakeet_v2_ger"