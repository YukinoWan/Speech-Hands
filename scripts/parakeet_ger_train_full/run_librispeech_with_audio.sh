...
#SBATCH --job-name=qwen2_5omni_full_sharegpt_librispeech-ger-with-audio
#SBATCH --output=parakeet_log/qwen2_5omni_full_sharegpt_librispeech-ger-with-audio
#SBATCH --error=parakeet_log/qwen2_5omni_full_sharegpt_librispeech-ger-with-audio
#SBATCH --ntasks=1
...
sbatch ./scripts/parakeet_eval/eval_ger.sh "librispeech_test_clean" "parakeet_v2_ger"
sbatch ./scripts/parakeet_eval/eval_ger.sh "librispeech_train" "parakeet_v2_ger"
sbatch ./scripts/parakeet_eval/eval_ger.sh "librispeech_test_other" "parakeet_v2_ger"