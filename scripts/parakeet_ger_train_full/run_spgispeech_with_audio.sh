...
#SBATCH --job-name=qwen2_5omni_full_sharegpt_spgispeech-ger-with-audio
#SBATCH --output=parakeet_log/qwen2_5omni_full_sharegpt_spgispeech-ger-with-audio
#SBATCH --error=parakeet_log/qwen2_5omni_full_sharegpt_spgispeech-ger-with-audio
#SBATCH --ntasks=1
...
sbatch ./scripts/parakeet_eval/eval_ger.sh "spgispeech_test" "parakeet_v2_ger"
sbatch ./scripts/parakeet_eval/eval_ger.sh "spgispeech_train" "parakeet_v2_ger"