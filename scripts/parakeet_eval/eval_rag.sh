...
#SBATCH --output=parakeet_1_best_eval_log/qwen2_5omni_full_test_with_audio_rag_ckpt-1best-log
#SBATCH --error=parakeet_1_best_eval_log/qwen2_5omni_full_test_with_audio_rag_ckpt-1best-err
#SBATCH --ntasks=1
