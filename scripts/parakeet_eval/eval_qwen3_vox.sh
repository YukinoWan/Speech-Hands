...
#SBATCH --output=qwen3_eval_log/qwen3omni_vox-official-baseline-with-audio-log
#SBATCH --error=qwen3_eval_log/qwen3omni_vox-official-baseline-with-audio-err
#SBATCH --ntasks=1
...
python test_qwen3_audio_baseline.py "voxpopuli_test" ${1}