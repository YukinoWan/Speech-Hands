...
#SBATCH --job-name=qwen2_5omni_full_sharegpt_spgispeech-whisper-5-best-no-audio
#SBATCH --output=log/qwen2_5omni_full_sharegpt_spgispeech-whisper-5-best-no-audio
#SBATCH --error=log/qwen2_5omni_full_sharegpt_spgispeech-whisper-5-best-no-audio
#SBATCH --ntasks=1
