...
#SBATCH --job-name=qwen2_5omni_full_sharegpt_gigaspeech-rag-with-audio
#SBATCH --output=parakeet_log/qwen2_5omni_full_sharegpt_gigaspeech-rag-with-audio
#SBATCH --error=parakeet_log/qwen2_5omni_full_sharegpt_gigaspeech-rag-with-audio
#SBATCH --ntasks=1
...
sbatch ./scripts/parakeet_eval/eval_rag.sh "gigaspeech_test" "parakeet-ger_rag"