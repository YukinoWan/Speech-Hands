...
#SBATCH --job-name=qwen2_5omni_full_sharegpt_librispeech-rag-with-audio
...
sbatch ./scripts/parakeet_eval/eval_rag.sh "librispeech_test_clean" "parakeet-ger_rag"
sbatch ./scripts/parakeet_eval/eval_rag.sh "librispeech_test_other" "parakeet-ger_rag"