...
#SBATCH --output=parakeet_log/qwen2_5omni_full_sharegpt_ami-rag-with-audio
#SBATCH --error=parakeet_log/qwen2_5omni_full_sharegpt_ami-rag-with-audio
#SBATCH --ntasks=1
...
sbatch ./scripts/parakeet_eval/eval_rag.sh "ami_test" "parakeet-ger_rag"