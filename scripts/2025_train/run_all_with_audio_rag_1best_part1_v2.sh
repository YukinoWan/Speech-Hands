...
#SBATCH --output=2025_log/qwen2_5omni_2025_sharegpt_rag-with-audio-1best-part1
#SBATCH --error=2025_log/qwen2_5omni_2025_sharegpt_rag-with-audio-1best-part1
#SBATCH --ntasks=1
...
FORCE_TORCHRUN=1 llamafactory-cli train examples/2025_train_full/qwen2_5omni_full_sft_2025_with_audio_rag_1best_part1.yaml
