...
#SBATCH --job-name=qwen2_5omni_full_sharegpt_voxpopuli-whisper-5-best-with-audio-v2
#SBATCH --output=log/qwen2_5omni_full_sharegpt_voxpopuli-whisper-5-best-with-audio-v2-log
#SBATCH --error=log/qwen2_5omni_full_sharegpt_voxpopuli-whisper-5-best-with-audio-v2-err
#SBATCH --ntasks=1
