...
#SBATCH --job-name=qwen2_5omni_full_sharegpt_ami-whisper-5-best-with-audio
#SBATCH --output=log/qwen2_5omni_full_sharegpt_ami-whisper-5-best-with-audio-v7
#SBATCH --error=log/qwen2_5omni_full_sharegpt_ami-whisper-5-best-with-audio-v7
#SBATCH --ntasks=1
