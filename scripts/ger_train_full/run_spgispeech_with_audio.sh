...
#SBATCH --job-name=qwen2_5omni_full_sharegpt_spgispeech-whisper-5-best-with-audio
#SBATCH --output=log/qwen2_5omni_full_sharegpt_spgispeech-whisper-5-best-with-audio-v6
#SBATCH --error=log/qwen2_5omni_full_sharegpt_spgispeech-whisper-5-best-with-audio-v6
#SBATCH --ntasks=1
...
FORCE_TORCHRUN=1 llamafactory-cli train examples/train_full/qwen2_5omni_full_sft_spgispeech_with_audio.yaml
