...
#SBATCH --output=qwen3_eval_log/qwen3omni_earnings22-official-baseline-with-audio-log
#SBATCH --error=qwen3_eval_log/qwen3omni_earnings22-official-baseline-with-audio-err
#SBATCH --ntasks=1
...
python test_qwen3_audio_baseline.py "earnings22_test" ${1}
