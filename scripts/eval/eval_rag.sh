...
#SBATCH --output=parakeet_5_best_eval_log/qwen2_5omni_full_tedlium_test_with_audio_rag_ckpt-v1-log
#SBATCH --error=parakeet_5_best_eval_log/qwen2_5omni_full_tedlium_test_with_audio_rag_ckpt-v1-err
#SBATCH --ntasks=1
...
CUDA_VISIBLE_DEVICES=0 python test_qwen_rag.py ${1} ${2}
