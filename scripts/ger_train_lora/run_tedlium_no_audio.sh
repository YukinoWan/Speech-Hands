...
#SBATCH --job-name=qwen2_5omni_lora_sharegpt_tedlium-whisper-5-best-no-audio
#SBATCH --output=log/qwen2_5omni_lora_sharegpt_tedlium-whisper-5-best-no-audio
#SBATCH --error=log/qwen2_5omni_lora_sharegpt_tedlium-whisper-5-best-no-audio
#SBATCH --ntasks=1
