...
#SBATCH --job-name=qwen2_5omni_lora_sharegpt_voxpopuli-whisper-5-best-no-audio
#SBATCH --output=log/qwen2_5omni_lora_sharegpt_voxpopuli-whisper-5-best-no-audio
#SBATCH --error=log/qwen2_5omni_lora_sharegpt_voxpopuli-whisper-5-best-no-audio
#SBATCH --ntasks=1
...
FORCE_TORCHRUN=1 llamafactory-cli train examples/train_lora/qwen2_5omni_lora_sft_voxpopuli_no_audio.yaml
