...
#SBATCH --job-name=voxpopuli_1best
#SBATCH --output=parakeet_log/voxpopuli_1best
#SBATCH --error=parakeet_log/voxpopuli_1best
#SBATCH --ntasks=1
...
FORCE_TORCHRUN=1 llamafactory-cli train examples/parakeet_rag_1best/qwen2_5omni_full_sft_voxpopuli_with_audio_rag.yaml
bash ./merge_full_rag.sh "voxpopuli" "parakeet-1best"

sbatch ./scripts/parakeet_eval/eval_rag.sh "voxpopuli_test" "parakeet-1best"