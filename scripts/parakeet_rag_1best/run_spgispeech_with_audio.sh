...
#SBATCH --job-name=spgispeech_1best
#SBATCH --output=parakeet_log/spgispeech_1best
#SBATCH --error=parakeet_log/spgispeech_1best
#SBATCH --ntasks=1
...
sbatch ./scripts/parakeet_eval/eval_rag.sh "spgispeech_test" "parakeet-1best"