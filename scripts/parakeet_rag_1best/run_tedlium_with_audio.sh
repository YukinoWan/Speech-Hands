...
#SBATCH --job-name=tedlium_1best
#SBATCH --output=parakeet_log/tedlium_1best
#SBATCH --error=parakeet_log/tedlium_1best
#SBATCH --ntasks=1
...
sbatch ./scripts/parakeet_eval/eval_rag.sh "tedlium_test" "parakeet-1best"