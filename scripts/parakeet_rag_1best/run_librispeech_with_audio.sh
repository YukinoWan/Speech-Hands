...
#SBATCH --job-name=librispeech_1best
#SBATCH --output=parakeet_log/librispeech_1best
#SBATCH --error=parakeet_log/librispeech_1best
#SBATCH --ntasks=1
...
sbatch ./scripts/parakeet_eval/eval_rag.sh "librispeech_test_clean" "parakeet-1best"
sbatch ./scripts/parakeet_eval/eval_rag.sh "librispeech_test_other" "parakeet-1best"