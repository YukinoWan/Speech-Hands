...
#SBATCH --job-name=qwen2_5omni_full_sharegpt_ami-rag-with-audio
#SBATCH --output=parakeet_log/qwen2_5omni_full_sharegpt_ami-rag-with-audio-v1
#SBATCH --error=parakeet_log/qwen2_5omni_full_sharegpt_ami-rag-with-audio-v1
#SBATCH --ntasks=1
...
FORCE_TORCHRUN=1 llamafactory-cli train examples/rag_train_full/qwen2_5omni_full_sft_ami_with_audio_rag.yaml
