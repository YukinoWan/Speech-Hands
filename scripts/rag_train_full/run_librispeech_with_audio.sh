...
#SBATCH --output=parakeet_log/qwen2_5omni_full_sharegpt_librispeech-rag-with-audio-v1-log
#SBATCH --error=parakeet_log/qwen2_5omni_full_sharegpt_librispeech-rag-with-audio-v1-err
#SBATCH --ntasks=1
...
FORCE_TORCHRUN=1 llamafactory-cli train examples/rag_train_full/qwen2_5omni_full_sft_librispeech_with_audio_rag.yaml
