...
#SBATCH --output=parakeet_log/qwen2_5omni_full_sharegpt_gigaspeech-rag-with-audio-v1
#SBATCH --error=parakeet_log/qwen2_5omni_full_sharegpt_gigaspeech-rag-with-audio-v1
#SBATCH --ntasks=1
